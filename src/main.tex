...
\address{
    \emoji{pig-face} \textbf{Animal} Pig
    \\
    \emoji{grinning-face} \textbf{Personality} Assertive Architect (\href{https://www.16personalities.com/intj-personality/}{INTJ-A})
    \\
    \emoji{star} \textbf{Zodiac} Cancer, Libra ascendant
}
