...
\item
    ...
    \begin{list}{\raisebox{2.0pt}{\tiny$\bullet$}\space}{\setlength{\leftmargin}{11.2pt}}
        \itemsep -4.0pt \vspace{-4.0pt}
        \item Worked in Customer 360, Customer Marketplace, Customer Product \& Experience; managed and operated the software platform and data that power customer experiences for real estate agencies and businesses.
        ...
        \item Led development of Customer Marketing Email Archiver; built a service in Lambda to process and archive email copies, facilitating access to the marketing communication history.
    \end{list}
\item 
    ...
    \begin{list}{\raisebox{2.0pt}{\tiny$\bullet$}\space}{\setlength{\leftmargin}{11.2pt}}
        ...
        \item Led development of Executor for Change Automation; engineered the system architecture; designed and implemented State Machine Activity workers in Step Functions to enable execution of automated changes.
...
\item
    ...
    \begin{list}{\raisebox{2.0pt}{\tiny$\bullet$}\space}{\setlength{\leftmargin}{11.2pt}}
        \itemsep -4.0pt \vspace{-4.0pt}
        \item Worked in School of Computing and Information Systems, Faculty of Engineering and Information Technology; assisted course coordinator to conduct classes, prepare teaching materials, supervise examinations, and assess student assignments.
