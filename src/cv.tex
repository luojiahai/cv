...
\emoji{desktop-computer} \textbf{\uppercase{Professional Experience}}
\sectionlineskip
\hrule
...
\item 
    ...
    \begin{list}{\raisebox{0.2em}{\tiny$\bullet$} \hspace{0em}}{\setlength{\leftmargin}{2.0em}}
        ...
        % \item Built a caching solution with Cachemere int the API to preserve user data and serve efficiently, reducing requests to the directory service and improving website page load speed by 50\%.
...
\emoji{rocket} \textbf{\uppercase{Technical Skills}}
\sectionlineskip
\hrule
\begin{list}{}{\setlength{\leftmargin}{0em}}
\itemsep -0.3em
...
\emoji{graduation-cap} \textbf{\uppercase{Education}}
\sectionlineskip
\hrule
\begin{list}{}{\setlength{\leftmargin}{0em}}
\itemsep 0.3em
