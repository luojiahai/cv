...
\item
    \textbf{Technologies}: Python, TypeScript, Java, C, AWS, Docker, Hugging Face, Kafka, GraphQL, Node.js, SQL, \LaTeX
\end{list}
...
\item 
    ...
    \begin{list}{\raisebox{2.0pt}{\tiny$\bullet$}\space}{\setlength{\leftmargin}{11.2pt}}
        ...
        \item Contributed to the development of Change Automation; reformed event-streaming services to sync new data to secondary storage; built services to automate changes on integrated systems, increasing change velocity, reducing errors, and minimising user toil.
