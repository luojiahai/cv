...
\item
    ...
    \begin{list}{\raisebox{2.0pt}{\tiny$\bullet$}\space}{\setlength{\leftmargin}{11.2pt}}
        \itemsep -4.0pt \vspace{-4.0pt}
        \item Coursework: Algorithms, Object Oriented Software Development, Software Modelling and Design, Database Systems, Computer Systems
    \end{list}
\item
...
\item
    \textbf{Personality}: Assertive Architect (INTJ-A) -- a quiet individual who values organisation, rationality, and imaginative solutions to problems
\end{list}
